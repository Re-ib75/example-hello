...
|
*/
Route::resource('productss', ProductController::class)->names([
    'index' => 'productss.index',
    'create' => 'productss.create',
    'store' => 'productss.store',

    'show' => 'productss.show',
    'edit' => 'productss.edit',
    'update' => 'productss.update',
    'destroy' => 'productss.destroy',
]);
